...
[e0,valid,m0] = energy_eval(s0_1',false);
if(valid)
...
toc;
[e1,valid,m1] = energy_eval(s1',false);
if(valid)
...
t = toc;
[e2,valid,m2] = energy_eval(opt_s',true,[94,39,29]/100);
e2 = e2/1000;
if(valid)
...
tidm = toc;
[e3,valid,m3] = energy_eval(yIDM(2,:)',true,[24,7,43]/100);
e3 = e3/1000;
if(valid)
...
write2csv('D:\3stageworkspace\3stage\idm_res.csv',scenario,e3);
write2csv('D:\3stageworkspace\3stage\idm_time.csv',scenario,tidm);
%% DP Baseline
...
[e4,valid,m4] = energy_eval(st',true,[0.00,0.63,0.95]);
%% 增加图例
figure(1)
...
set(gcf,'unit','centimeters', 'position',[12,5,14,8.6]); % positon(1)(2)绘图窗口显示位置;pos(3)(4),窗口长宽值
figure(3)
legend([m2,m3,m4],'3-Stage','IDM','DP','location','northwest','box','on');
%%
